...
class PDSS():
    ...
    #
    #  
    ## 1 - Generate text queires with max alph size 512 for spaces between two sequential tokens: xQueries
    ## 2-  In a loop, get predictions/scores from a passed pre-trained model : ptModel
    ## 3-  Verify all predictions using linqustic rules, defined in the class greedy selection    
